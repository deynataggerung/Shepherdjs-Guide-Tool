...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WindowBus; });
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    css: function (sel, parent) {
        ...
        let els = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.toArray(parent.querySelectorAll(normalUnionCss))
        ...
        return Array.from(newEls).sort((a,b) => {
            ...
            for (let i = 0; i < Math.min(aPath.length, bPath.length); i++) {
                ...
                let childNodes = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.toArray(commonParent.childNodes)
...
/* harmony import */ var _sidebar_main_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14);




window.vue = new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
    el: '#main',
    render: h => h(_sidebar_main_vue__WEBPACK_IMPORTED_MODULE_1__["default"])
})
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sidebar_main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ab691e0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_sidebar_main_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
/* harmony import */ var _node_modules_vue_loader_lib_runtime_component_normalizer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
var disposed = false
/* script */
...
var Component = Object(_node_modules_vue_loader_lib_runtime_component_normalizer__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _sidebar_main_js__WEBPACK_IMPORTED_MODULE_0__["default"],
  _node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ab691e0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_sidebar_main_vue__WEBPACK_IMPORTED_MODULE_1__["render"],
  _node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ab691e0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_sidebar_main_vue__WEBPACK_IMPORTED_MODULE_1__["staticRenderFns"],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src\\sidebar-main.vue"
...
/* harmony import */ var _sidebar_main_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14);
/* harmony import */ var _bus_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
/* harmony import */ var _selector_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
...
const parentBus = new _bus_js__WEBPACK_IMPORTED_MODULE_3__["default"]()

// Utils
////////////////////////////////////////////////////////////////////////////////

function toBooleanSorters (sorters) {
    return sorters.map(sorter => lodash__WEBPACK_IMPORTED_MODULE_1___default.a.isFunction(sorter) ? lodash__WEBPACK_IMPORTED_MODULE_1___default.a.negate(sorter) : v => v != sorter)
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: async function () {
        ...
        Object.entries(storage).forEach(([k,v]) => {
            ...
            vue__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.templates, id, t)
        })
        ...
        if (!id) {
            ...
            this.stashedTemplate = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.cloneDeep(this.template)
        }
    },
    mounted: function () {
    ...
    computed: {
        ...
        sortedTemplates () {
            if (!this.loc) return []
            return lodash__WEBPACK_IMPORTED_MODULE_1___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.values(this.templates), [
        ...
        sortedSelElemAttrs () {
            ...
            let sorters = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.concat(toBooleanSorters(htmlAttrImportance), lodash__WEBPACK_IMPORTED_MODULE_1___default.a.identity)
            let pairsSorters = sorters.map(s => v => s(v[0]))
            return this.selElemAttrs.map(attrs => {
                return lodash__WEBPACK_IMPORTED_MODULE_1___default.a.sortBy(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.toPairs(attrs), pairsSorters)
            })
        },
        templateStat () {
            return lodash__WEBPACK_IMPORTED_MODULE_1___default.a.values(this.sortedTemplates).map(t => {
                let liveSels = '?'
                let matchPower = 'low'
                let fields = t.fields.slice(0, -1)
                let hasUndefined = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.find(fields, f => this.selCovers[f.attachTo.element] === undefined)
                if (!hasUndefined) {
                    liveSels = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.filter(fields, f => this.selCovers[f.attachTo.element] > 0).length
    ...
    methods: {
        ...
        onKeyUp (e) {
            ...
            let isRoot = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.includes([undefined, document.body], e.target)

            if (e.keyCode === 27) {
                // esc
                this.resetView()
            } else if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.includes([8,46], e.keyCode) && isRoot && this.pickingField) {
                // backspace
                this.resetSelector(this.pickingField)
            } else if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.includes([37,39], e.keyCode) && isRoot) {
                // < and > arrow keys
        ...
        getAllSelectors (templates) {
            return lodash__WEBPACK_IMPORTED_MODULE_1___default.a.chain(templates).values()
        ...
        augmentTemplate (t, id) {
            ...
            t.lastLoc = new URL(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.last(t.urls) || this.loc.href)
            t.fields.push(this.makeField())
        },
        cloneCurrentTemplate () {
            let t = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.cloneDeep(this.template)
            t.id = '_' + Date.now()
            t.page += ' New'
            this.template = t
            this.commitTemplate()
        ...
        revertTemplate () {
            ...
            this.stashedTemplate = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.cloneDeep(this.template)
            vue__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.templates, this.template.id, this.template)
            this.templateEdited = false
        },
        async newTemplate () {
            this.loc = new URL(await this.sendMessage('getLocation'))
        ...
        removeSelectedTemplates () {
            this.templates = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.omit(this.templates, this.selectedTemplates)
            this.sendMessage('removeStorageKeys', this.selectedTemplates)
            this.selectedTemplates = []
        },
        selectTemplate (t) {
            if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.includes(this.selectedTemplates, t.id))
                this.selectedTemplates = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.without(this.selectedTemplates, t.id)
            else
                this.selectedTemplates.push(t.id)
        },
        selectAllTemplates () {
            if (this.selectedTemplates.length) this.selectedTemplates = []
            else this.selectedTemplates = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.keys(this.templates)
        },
        commitTemplate () {
            this.templateEdited = true
            if (!lodash__WEBPACK_IMPORTED_MODULE_1___default.a.includes(this.template.urls, this.loc.href))
                this.template.urls.push(this.loc.href)
            vue__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.templates, this.template.id, this.template)
            let template = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.pick(this.template, ['page', 'fields', 'created', 'urls'])
        ...
        findTemplate () {
            ...
            return new Promise(async resolve => {
                ...
                let candidates = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.pickBy(this.templates, t => {
                    return t.lastLoc.hostname === this.loc.hostname
                })

                let id2sels = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.mapValues(candidates, t => lodash__WEBPACK_IMPORTED_MODULE_1___default.a.map(t.fields, 'selector'))
                let uniqSels = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.chain(id2sels).values().flatMap().uniq().value()
                ...
                let id = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.findKey(candidates, t => {
                    return (t.lastLoc.hostname + t.lastLoc.pathname) === (this.loc.hostname + this.loc.pathname)
                })
                resolve(id)
            })
        },
        onTemplateTitleInput: lodash__WEBPACK_IMPORTED_MODULE_1___default.a.debounce(function () {this.commitTemplate()}, 300),
        ...
        onPickerClick (f, e) {
            if (f === lodash__WEBPACK_IMPORTED_MODULE_1___default.a.last(this.fields)) this.addField()
        ...
        enablePicker (f) {
            ...
            let idx = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.findIndex(this.fields, ff => ff === f)
            setTimeout(() => {
                // if (this.$refs) {
        ...
        _onSelectorInput: lodash__WEBPACK_IMPORTED_MODULE_1___default.a.debounce(function (f) {
        ...
        _onFieldNameInput: lodash__WEBPACK_IMPORTED_MODULE_1___default.a.debounce(function () {this.commitTemplate()}, 300),
        ...
        async getSelElemAttrs (sel) {
            ...
            this.selElemUniqAttrs = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.chain(data)
                .flatMap(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.keys).uniq().sortBy(sorters).value()
            this.attrToShow = this.selElemUniqAttrs[0]
        },
        cloneField (idx) {
            this.template.fields.splice(idx, 0, lodash__WEBPACK_IMPORTED_MODULE_1___default.a.cloneDeep(this.fields[idx]))
            this.commitTemplate()
        },
        resetSelector (f) {
            if (!f) return
        ...
        async exportTemplates () {
            let storage = await this.sendMessage('loadStorage')
            let templates = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.pick(storage, this.selectedTemplates)
            let templateArray = []
        ...
        async commitImportedTemplates (object) {
            ...
            this.sendMessage('saveStorage', lodash__WEBPACK_IMPORTED_MODULE_1___default.a.fromPairs(templates))
            templates.forEach(([id,t]) => {
                this.augmentTemplate(t, id)
                vue__WEBPACK_IMPORTED_MODULE_0__["default"].set(this.templates, id, t)
            })
            this.checkAndUpdateSelectors(this.getAllSelectors(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.fromPairs(templates)))
        },
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "sidebar" } }, [
    _c("div", { attrs: { id: "head-controls" } }, [
      _c("div", { staticClass: "buttons" }, [
        _c("div", [
          _c("button", {
            staticClass: "blue plain-button fas fa-plus",
            attrs: { title: "Create new template" },
            on: { click: _vm.newTemplate }
          }),
          _vm._v(" "),
          _c("button", {
            staticClass: "plain-button fas fa-arrows-alt-h",
            attrs: { title: "Toggle sidebar position" },
            on: {
              click: function($event) {
                _vm.sendMessage("togglePosition")
              }
            }
          }),
          _vm._v(" "),
          _c("button", {
            staticClass: "plain-button fas fa-list",
            attrs: { title: "Show all archived templates" },
            on: { click: _vm.openTemplatesView }
          }),
          _vm._v(" "),
          _c("button", {
            staticClass: "plain-button fas fa-pencil-alt",
            attrs: { title: "Edit template as JSON" },
            on: { click: _vm.openJsonEditor }
          }),
          _vm._v(" "),
          _c("button", {
            staticClass: "plain-button far fa-clone",
            attrs: {
              disabled: !this.templates[this.template.id],
              title: "Clone current template"
            },
            on: { click: _vm.cloneCurrentTemplate }
          }),
          _vm._v(" "),
          _c("button", {
            staticClass: "plain-button fas fa-fast-backward",
            attrs: {
              title: "Undo all modifications",
              disabled: !_vm.stashedTemplate || !_vm.templateEdited
            },
            on: { click: _vm.revertTemplate }
          })
        ]),
        _vm._v(" "),
        _c("button", {
          staticClass: "red plain-button fas fa-times",
          on: {
            click: function($event) {
              _vm.sendMessage("close")
            }
          }
        })
      ]),
      ...
      _c("div", { staticClass: "title" }, [
        _c("label", { staticClass: "left", attrs: { for: "template-title" } }, [
          _vm._v("Template: ")
        ]),
        _vm._v(" "),
        _c("input", {
          ...
          attrs: { id: "template-title" },
          domProps: { value: _vm.template.page },
          on: {
            input: [
              function($event) {
                ...
                _vm.$set(_vm.template, "page", $event.target.value)
              },
              _vm.onTemplateTitleInput
            ]
          }
        })
      ])
    ...
    _c(
      "div",
      { attrs: { id: "field-list" } },
      _vm._l(_vm.template.fields, function(field, i) {
        return _c(
          "div",
          {
            key: i,
            ...
            refInFor: true,
            staticClass: "field",
            class: { picking: field === _vm.pickingField },
            on: {
              mouseenter: function($event) {
                _vm.sendMessage("highlight", field.selector)
              },
              mouseleave: function($event) {
                _vm.sendMessage("unhighlight")
              }
            }
          },
          [
            _c("div", { staticClass: "inner" }, [
              _c("div", { staticClass: "top" }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: field.attachTo.on,
                        expression: "field.attachTo.on"
                      }
                    ],
                    staticClass: "text",
                    on: {
                ...
                _vm._v(" "),
                _c("button", {
                  staticClass: "orange plain-button fas fa-magic",
                  attrs: { title: "Start picker" },
                  on: {
                    click: function($event) {
                      _vm.onPickerClick(field, $event)
                    },
                ...
                _vm._v(" "),
                _c("button", {
                  staticClass: "plain-button far fa-circle",
                  attrs: {
                    disabled: i === _vm.fields.length - 1,
                    title: "Reset selector"
                  },
                  on: {
                    click: function($event) {
                      _vm.resetSelector(field)
                    }
                  }
                }),
                _vm._v(" "),
                _c("button", {
                  staticClass: "plain-button fas fa-minus",
                  attrs: { disabled: i === _vm.fields.length - 1 },
                  on: {
                    click: function($event) {
                      _vm.removeField(i)
                    }
              ...
              _c("div", { staticClass: "bottom" }, [
                  ...
                  directives: [
                    {
                      ...
                      value: field.attachTo.element,
                      expression: "field.attachTo.element",
                      modifiers: { trim: true }
                    }
                  ],
                  staticClass: "selector",
                  class: { error: _vm.fieldCovers[i] === -1 },
                  attrs: { placeholder: "css or xpath" },
                  domProps: { value: field.attachTo.element },
                  on: {
                    input: [
                      function($event) {
                        if ($event.target.composing) {
                ...
                _c(
                  ...
                  [
                    _vm._v(
                      _vm._s(_vm.fieldCovers[i] === -1 ? 0 : _vm.fieldCovers[i])
                    )
                  ]
                )
              ]),
                ...
                _c("input", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(field, "title", $event.target.value.trim())
                    },
                    blur: function($event) {
                      _vm.$forceUpdate()
                    }
              ...
              _c("div", { staticClass: "bottom" }, [
                _c("textarea", {
                  ...
                  class: { error: _vm.fieldCovers[i] === -1 },
                  attrs: { placeholder: "content", rows: "2" },
                  domProps: { value: field.text },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(field, "text", $event.target.value.trim())
                    },
                    blur: function($event) {
                      _vm.$forceUpdate()
                    }
              ...
              _vm._v(" "),
              i !== _vm.fields.length - 1
                ? _c("div", {
                    staticClass: "indicator",
                    class: [
                      _vm.fieldCovers[i] === undefined
                        ? "unknown"
                        : _vm.fieldCovers[i] > 0
                          ? "good"
                          : "bad"
      ...
      ? _c(
          ...
          [
            _c("div", { attrs: { id: "conf" } }, [
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.options.autonojs,
                        expression: "options.autonojs"
                      }
                    ],
                    attrs: { type: "checkbox" },
                    domProps: {
                      checked: Array.isArray(_vm.options.autonojs)
                        ? _vm._i(_vm.options.autonojs, null) > -1
                        : _vm.options.autonojs
                    },
                    on: {
                      change: function($event) {
                        var $$a = _vm.options.autonojs,
                          $$el = $event.target,
                        ...
                        if (Array.isArray($$a)) {
                          ...
                          _vm.$set(_vm.options, "autonojs", $$c)
                        }
                      }
                    }
                  }),
                  _vm._v("Automatically disable JavaScript.")
                ])
              ]),
              _vm._v(" "),
              _c("b", [_vm._v("Data Tab:")]),
              _c("br"),
              _vm._v(
                "\r\n            In picking mode data previews show a few special properties alongside element real attributes."
              ),
              _c("br"),
              _vm._v("\r\n            Those are:"),
              _c("br"),
              _vm._v("\r\n            _html - element inner html."),
              _c("br"),
              _vm._v(
                '\r\n            _tag - element tag name (e.g. "a", "div", "span").'
              ),
              _c("br"),
              _vm._v(
                "\r\n            _text - list of element direct texts (e.g. "
              ),
              _c("span", { staticStyle: { color: "#af4356" } }, [
                _vm._v("<span>hello <b>to</b> you</span>")
              ]),
              _vm._v(' will be ["hello ", " you"]).'),
              _c("br"),
              _vm._v(
                '\r\n            _val - value under special nonstandard css pseudo elements if used (e.g. "div a::attr(href)"), these are supported by scrapy for example.'
              ),
              _c("br"),
              _c("br"),
              _vm._v(" "),
              ...
              _c("br"),
              _vm._v(
                "\r\n            Left/Right Arrow Keys - toggle sidebar position."
              ),
              _c("br"),
              _vm._v(
                "\r\n            Backspace, Delete - (in picking mode) reset current selector."
              ),
              _c("br"),
              _vm._v(
                "\r\n            Esc - dismiss current popup or turn off picking mode."
              ),
              _c("br")
            ])
          ]
          ...
          "div",
          {
            ...
            on: {
              click: function($event) {
                ...
                return _vm.resetView($event)
              }
            }
          },
          [
            _c("div", { attrs: { id: "templates-list" } }, [
              _c("div", { staticClass: "buttons" }, [
                _c(
                  "label",
                  {
                    staticClass: "custom-file-picker plain-button",
                    attrs: { title: "Import new templates from file" }
                  },
                  [
                    _c("input", {
                      attrs: { type: "file" },
                ...
                _c(
                  ...
                  {
                    staticClass: "plain-button",
                    attrs: { disabled: !_vm.selectedTemplates.length },
                    on: { click: _vm.removeSelectedTemplates }
                  },
                  [_vm._v("delete")]
                ),
                _vm._v(" "),
                _c(
                  ...
                  {
                    staticClass: "plain-button",
                    on: { click: _vm.selectAllTemplates }
                  },
                  [
                    _vm._v(
                      _vm._s(_vm.selectedTemplates.length ? "none" : "all")
                    )
                  ]
                )
              ]),
              ...
              _c(
                "div",
                { staticClass: "list" },
                _vm._l(_vm.sortedTemplates, function(t, i) {
                  return _c(
                    "div",
                    {
                      key: t.id,
                      staticClass: "template",
                      class: { selected: _vm.selectedTemplates.includes(t.id) },
                      attrs: { title: t.page },
                      on: {
                        click: function($event) {
                          _vm.selectTemplate(t)
                        },
                    ...
                    [
                      ...
                      _c(
                        ...
                        {
                          staticClass: "stat",
                          class: [_vm.templateStat[i].matchPower]
                        },
                        [_vm._v(_vm._s(_vm.templateStat[i].selCount))]
                      )
                    ]
                  )
                })
    ...
    _vm.jsonEditorView
      ? _c(
          ...
          [
            _c("div", { attrs: { id: "json-editor" } }, [
              _c("div", { staticClass: "buttons" }, [
                _c(
                  "button",
                  {
                    staticClass: "plain-button",
                    on: { click: _vm.copyJsonEditor }
                  },
                  [_vm._v("copy")]
                ),
                _vm._v(" "),
                _c(
                  ...
                  {
                    staticClass: "plain-button",
                    attrs: { disabled: _vm.jsonEditorIsReset },
                    on: { click: _vm.resetJsonEditor }
                  },
                  [_vm._v("reset")]
                ),
                _vm._v(" "),
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.jsonEditorText,
                    expression: "jsonEditorText"
                  }
                ],
                ref: "jsonEditor",
                domProps: { value: _vm.jsonEditorText },
                on: {
                  input: [
                    function($event) {
                      if ($event.target.composing) {
                      ...
                      _vm.jsonEditorText = $event.target.value
                    },
                    function($event) {
                      _vm.jsonEditorIsReset = false
                    }
                  ]
                }
              })
