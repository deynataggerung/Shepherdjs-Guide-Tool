...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  /* webextension-polyfill - v0.2.1 - Tue Apr 17 2018 04:48:39 */
...
/* harmony import */ var _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _bus_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
/* harmony import */ var _selector_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
...
const iframeBus = new _bus_js__WEBPACK_IMPORTED_MODULE_2__["default"]()

let selectorGadget, sidebarIFrame

window.browser = _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a
...
function onKeyUp (e) {
	if (selectorGadget) {
		// delegate to iframe
		e = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.pick(e, ['ctrlKey', 'shiftKey', 'altKey', 'metaKey', 'repeat', 'keyCode', 'key'])
...
function tellRuntime (method, arg) {
	return _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.runtime.sendMessage([method, arg])
}
...
function initUI (cb) {
	...
	// inject sidebar
	let props = {id: 'ScrapeMate', src: _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.extension.getURL(SOURCES.sidebarIFrame)}
	sidebarIFrame = Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["insertElem"])('iframe', props, document.body)
...
const exposed = {
    ...
    checkSelectors (selectors, respond) {
        ...
        selectors.forEach(sel => {
			if (!sel) {
				...
				let [type,elems] = _selector_js__WEBPACK_IMPORTED_MODULE_3__["default"].select(sel)
	...
	loadStorage () {
		return _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.storage.sync.get()
	},

	removeStorageKeys (keys) {
		_vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.storage.sync.remove(keys)
	},

	saveStorage (obj) {
		_vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.storage.sync.set(obj)
	},

	getSelElemAttrs (selector) {
		// selector -> [{attr:val, attr:val...}, ...]

		let selected = _selector_js__WEBPACK_IMPORTED_MODULE_3__["default"].select(selector)[1]

		let elems = []
		lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(selected, el => {
			let targetEl = _selector_js__WEBPACK_IMPORTED_MODULE_3__["default"].asElementNode(el)
			...
			lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(targetEl.attributes, attr => {
				attrs[attr.name] = attr.value
			})

			let ownText = _selector_js__WEBPACK_IMPORTED_MODULE_3__["default"].xpath('text()', targetEl).map(el => el.data)
	...
	highlight (selector) {
		this.unhighlight()
		lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(_selector_js__WEBPACK_IMPORTED_MODULE_3__["default"].select(selector)[1], el => {
			// TODO:low there should probably be an easier call that skips whole big css augmentation deal when we dont need it
			return _selector_js__WEBPACK_IMPORTED_MODULE_3__["default"].asElementNode(el).classList.add('ScrapeMate_highlighted')
		})
    },

	unhighlight () {
		lodash__WEBPACK_IMPORTED_MODULE_1___default.a.forEach(document.querySelectorAll('.ScrapeMate_highlighted'),
...
function main () {
	...
	_vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.runtime.onMessage.addListener(function(request, sender, sendResponse) {
	...
	SOURCES.styles.forEach(f => {
		let url = _vendor_browser_polyfill_js__WEBPACK_IMPORTED_MODULE_0___default.a.extension.getURL(f)
		Object(_util_js__WEBPACK_IMPORTED_MODULE_4__["insertElem"])('link', {rel: 'stylesheet', href: url}, document.body)
	})
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "insertElem", function() { return insertElem; });
...
function insertElem(type, props, target) {
